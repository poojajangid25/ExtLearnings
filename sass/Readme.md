...
folder are mapped to the application's root namespace, 'ExtSample01'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtSample01"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtSample01' in the same way
as `"ExtSample01/sass/src"`.
